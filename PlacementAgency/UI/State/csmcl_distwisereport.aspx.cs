...
{
    public partial class csmcl_distwisereport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Ensure the Print button calls the correct client ids for maincont and filters at render time
            if (btnPrint != null && maincont != null && ddldistrictAgent != null && ddlFYAg != null && ddlMonthAg != null)
            {
                btnPrint.OnClientClick = string.Format("printElement('{0}','{1}','{2}','{3}'); return false;",
                    maincont.ClientID, ddldistrictAgent.ClientID, ddlFYAg.ClientID, ddlMonthAg.ClientID);
            }
        }
        ...
        private void LoadDocuments()
        {
            ...
            {
                DatabaseHelper.Param("@District_ID", ddldistrictAgent.SelectedValue),
